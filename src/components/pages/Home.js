...
const Home = () => {
  return (
    <React.Fragment>
      <h1 className="text-center text-primary text-capitalize my-4">Find everything in a snap at GrASP</h1>
  ...
  <div className="card-body">
    ...
    {/*<a href="https://en.wikipedia.org/wiki/Computer_security" target="blank" className="btn btn-danger">Open</a>*/}
  </div>
</div></div>
  ...
  <div className="card-body">
    ...
    <p className="card-text">Dummy text</p>
    {/*<a href="https://en.wikipedia.org/wiki/Artificial_intelligence" target="blank" className="btn btn-danger">Open</a>*/}
  </div>
</div></div>
  <div className="col-sm"><div className="card">
  ...
  <div className="card-body">
    ...
    <p className="card-text">Dummy text</p>
    {/*<a href="https://en.wikipedia.org/wiki/Machine_learning" target="blank" className="btn btn-danger">Open</a>*/}
  </div>
</div></div>
</div><br/>
{/*<div className="row">
<div className="col-sm"><div className="card">
  ...
  <div className="card-body">
    ...
    <a href="https://en.wikipedia.org/wiki/Data_science" target="blank" className="btn btn-danger">Open</a>
  </div>
</div></div>
{/* </div> */}
{/* <div className="row"> */}
{/*<div className="col-sm"><div className="card">
  ...
  <div className="card-body">
    ...
    <a href="https://en.wikipedia.org/wiki/Web_development" target="blank" className="btn btn-danger">Open</a>
  </div>
</div></div>
<div className="col-sm"><div className="card">
  ...
  <div className="card-body">
    ...
    <a href="https://en.wikipedia.org/wiki/Sales" target="blank" className="btn btn-danger">Open</a>
  </div>
</div></div>
</div>*/}
</div>
